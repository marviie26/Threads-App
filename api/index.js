...
mongoose
  .connect("mongodb+srv://marviie9:Adeoye123456789@cluster0.w62awkn.mongodb.net/", {
    useNewUrlParser: true,
    useUnifiedTopology: true,
  })
  // .connect("mongodb://127.0.0.1:27017/ThreadsApp", {
  //   useNewUrlParser: true,
  //   useUnifiedTopology: true,
  // })
...
const sendVerificationEmail = async (email, verificationToken) => {
  ...
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "marviie9@gmail.com",
      pass: "cgef xpts yxmt fphb",
    },
  });

  //compose the email message
  const mailOptions = {
    from: "marviie's threads.com",
    to: email,
...
app.put("/posts/:postId/:userId/like", async (req, res) => {
  ...
  const userId = req.params.userId; // Assume you have a way to get the logged-in user's ID
